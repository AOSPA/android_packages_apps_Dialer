...
public class GoogleDialerDatabaseHelper extends DialerDatabaseHelper {
    ...
    private void setupTables(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + "cached_number_contacts" + " (" +
                ...
                "lookup_key" + " TEXT" +
        ");");
        db.execSQL("CREATE INDEX cached_number_index ON cached_number_contacts (normalized_number);");
    ...
    public void prune(long timestamp) {
        ...
        getWritableDatabase().execSQL("DELETE FROM cached_number_contacts WHERE time_last_updated<?", mArgs1);
    }
    ...
    public void purgeSource(int type) {
        ...
        getWritableDatabase().execSQL("DELETE FROM cached_number_contacts WHERE source_type=?", mArgs1);
    }
}
