...
public class PeopleApiClient {
    ...
    private String buildLookupUrl(Context context, String s, boolean includePlaces, boolean isIncoming) {
    ...
    private PhoneNumberInfoImpl doLookup(Context context, String s, String s2, String s3, boolean includePlaces, boolean isIncoming) throws AuthException {
    ...
    private PhoneNumberInfoImpl lookupPhoneNumber(Context context, String s, String s2, String s3, String s4) throws AuthException {
    ...
    public PhoneNumberInfoImpl lookupByPhoneNumber(Context context, String s, String s2, String s3, boolean includePlaces, boolean isIncoming) {
